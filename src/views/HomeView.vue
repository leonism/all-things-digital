...
>>>>>>> parent of 1627ba9 (feat(blog): refactor blog components and views into modular structure)
    <HomeBlogGrid />
  </main>
</template>
...
import HomeBlogGrid from '@/components/content/HomeBlogGrid.vue';
import FeaturedPostSection from '@/components/blog/BlogFeaturedPostSection.vue';
import LatestPostsSection from '@/components/blog/BlogLatestPostsSection.vue';
=======
