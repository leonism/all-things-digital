 ...
 * @returns {string} - Optimized Cloudinary URL
 */
export function getResponsiveImageUrl(publicId, width, height = null, options = {}) {
 ...
 */
export function getHeroImageUrl(publicId, width = 1200, height = 630, options = {}) {
 ...
 */
export function getResponsiveSrcSet(publicId, sizes = [400, 800, 1200], options = {}) {
  return sizes
    .map(width => {
