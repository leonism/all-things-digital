<template>
  <main id="mainWrapper" class="max-w-4xl mx-5 sm:mx-5 md:mx-10 lg:mx-auto">
    ...
    <div v-else class="text-center text-gray-500 dark:text-gray-400 py-10">
      ...
      <p>
        Make sure you have Markdown files in `/src/data/posts/` and run `node
...
import BlogHeader from '@/components/header/HeaderBlog.vue';
import BlogArticleCard from '@/components/blog/BlogArticleCard.vue';
import postsData from '@/data/blog-data.json';
// import SearchInput from '../components/search/SearchInput.vue'; // If implementing inline search
