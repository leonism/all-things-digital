<template>
  <footer
    class="flex flex-col items-center max-w-4xl mx-auto my-10 border-t dark:border-slate-800/60">
    <!-- Footer Logo -->
    <div
      class="flex max-w-xs pt-5 mx-auto -mt-9 overflow-hidden drop-shadow-xs grayscale opacity-80">
      <img
    ...
    <div class="flex items-center justify-between max-w-xs pt-8 mx-auto">
      <a
        ...
        :key="index"
        :href="icon.href"
        class="ml-4 text-gray-400 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
        <svg
          :width="icon.width"
          :height="icon.height"
          fill="currentColor"
